...
export default function NavLinkLI({ text, to }) {
  const defaultStyle =
    "pb-1 border-gray-600 hover:border-b-2 hover:text-gray-400 transition";
  const activeStyle =
    "pb-1 border-gray-400 border-b-2 hover:text-gray-400 hover:border-gray-600 transition";
